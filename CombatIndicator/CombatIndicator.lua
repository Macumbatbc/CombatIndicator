...
ciCore.ciFrames["target"] = CreateCombatIndicatorForUnit("target", XPerl_TargetportraitFrame, {x = -200, y = -30}, 25)
ciCore.ciFrames["focus"] = CreateCombatIndicatorForUnit("focus", XPerl_FocusportraitFrame, {x = -270, y = -30}, 25)
